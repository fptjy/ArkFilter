...
ax.plot(x, y_2, label='DCF2(m=2048,b=4)', linestyle='-.', color="darkorange")
ax.plot(x, y_3, label='DCF1(m=1024,b=4)', linestyle='--', color="crimson")
...
# ax.set_xlim(0, 9.5)
# ax.set_ylim(0, 5)
ax.set_xlabel('time ($×$ 10$^4$ ms)', fontdict={"family": "Times New Roman", "weight": "normal", "size": 23})
ax.set_ylabel('capacity of filter ($×$ 10$^4$)', fontdict={"family": "Times New Roman", "weight": "normal", "size": 23})
...
# 添加图例
legend = ax.legend(loc='best', prop={'family': 'Times New Roman', "size": 17})

plt.show()

fig.savefig('C:/Users/fptjy/Desktop/tu/dynamic_test_VCF1.svg', dpi=600, format='svg')
...
ax.plot(x2, y2, label='DCF2(m=2048,b=4)', linestyle='-.', marker='o', color="darkorange", markersize='8')
ax.plot(x3, y3, label='DCF1(m=1024,b=4)', linestyle='--', marker='v', color="crimson", markersize='8')
# ax.plot(x4, y4, label='DAF', linestyle='-', marker='d', color="crimson", markersize='8')
ax.plot(x5, y5, label='Dynamic VCF', linestyle='-', marker='*', color="steelblue", markersize='8')
# ax.plot(x, y1, label='BF', linestyle='--', marker='*', color="steelblue", markersize='8')
# ax.plot(x, y2, label='CF', linestyle='--', marker='o', color="darkorange", markersize='8')
# ax.plot(x, y3, label='ArkF', linestyle='--', marker='v', color="crimson", markersize='8')
# ax.plot(x, y4, label='QF', linestyle='--', marker='d', color="mediumseagreen", markersize='8')
...
# ax.set_xlim(0, 9.5)
# ax.set_ylim(0, 1.4)
ax.set_xlabel('capacity of filter ($×$ 10$^4$)', fontdict={"family":"Times New Roman","weight": "normal", "size": 23})
ax.set_ylabel('CDF', fontdict={"family":"Times New Roman","weight": "normal", "size": 23})
# plt.xlabel("f: fingerprint size in bits", fontdict=) log$_{10}$ξ$^‘$
# 设置刻度
# ax.tick_params(axis='both')
ax.tick_params(labelsize=16)
...
fig.savefig('C:/Users/fptjy/Desktop/tu/dynamic_test_VCF2.svg', dpi=600, format='svg')
