...
class Ark_Filter(object):
    ...
    def __init__(self, capacity, bucket_size=1,
        ...
        self.buckets = [D_Ark_bucket.Bucket(size=bucket_size)
    ...
    def _get_fingerprint(self, item):
        finger = D_Ark_hashutils.hash_code(item) % (self.capacity * (self.capacity - 1))
        return finger
    ...
    def put_back(self, cin_C, cin_T, cin_f):
        C = cin_C
        T = cin_T
        f = cin_f
