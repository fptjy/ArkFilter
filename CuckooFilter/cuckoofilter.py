...
class CuckooFilter(object):
    ...
    def delete(self, item):
        ...
        return False
    #
    # def contains_fingerprint(self, fingerprint, bucket):
    #     """
    #     Check if the filter contains the item.
    #
    #     :param item: Item to check its presence in the filter.
    #     :return: True, if item is in the filter; False, otherwise.
    #     """
    #     j = self._get_alternate_index(bucket, fingerprint)
    #     if fingerprint in self.buckets[j] or fingerprint in self.buckets[bucket]:
    #         return True
    #     return False
...
# item = "sejsddawds"
# capacity = 2 ** 18
# fingerprint = hashutils.fingerprint(item, 16)
# print(fingerprint)
# h1 = hashutils.hash_code(item) % capacity
# print(h1)
# h2 = (h1 ^ hashutils.hash_code(fingerprint)) % capacity
# print(h2)
#
# h3 = h1 ^ (hashutils.hash_code(fingerprint) % capacity)
# print(h3)
#
# h4 = (h2 ^ hashutils.hash_code(fingerprint)) % capacity
# print(h4)
#
# h5 = (h3 ^ hashutils.hash_code(fingerprint)) % capacity
# print(h5)
#
# z = h1 ^ hashutils.hash_code(fingerprint)
# print(z)
